...
class ARKConfigOverrideNPCSpawnEntriesContainer(ARKConfigItemHandler):
    """
    ...
    def __init__(self):
        ...
        self._config_item = OrderedDict(
            {'ConfigOverrideNPCSpawnEntriesContainer': list()})
    ...
    def to_string(self, config_item=None):
        ...
        for key, value in config_item.items():
            if isinstance(value, list):
                ...
                if key == 'ConfigOverrideNPCSpawnEntriesContainer':
                    self._stack.append(key + '=(')
                else:
                    self._stack.append(key + '=')
