...
from confighandlers.configaddnpcspawnentriescontainer import ARKConfigAddNPCSpawnEntriesContainer


class TestARKConfigAddNPCSpawnEntriesContainer(unittest.TestCase):
    def setUp(self):
        self.test_config_string = ('ConfigAddNPCSpawnEntriesContainer=('
        ...
        self.test_config_item = OrderedDict(
            {'ConfigAddNPCSpawnEntriesContainer': OrderedDict({
                'NPCSpawnEntriesContainerClassString': 'DinoSpawnEntriesBeach_C',
                'NPCSpawnEntries': [
                    OrderedDict({
                        'AnEntryName': 'DragonSpawner',
        ...
        self.test_config = ARKConfigAddNPCSpawnEntriesContainer()
    ...
    def test_add_spawn_entry(self):
        ...
        container = self.test_config_item.get('ConfigAddNPCSpawnEntriesContainer')
